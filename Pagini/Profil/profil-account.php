...
switch ($_SESSION['selectedCurrency']) {
  case 'RON':
    ...
    $currentCurrency = '<span class="fw-bolder"> lei</span>';
    break;
  case 'EUR':
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between mx-3 pt-2">
          ...
          <div class="dropdown text-center">
            <a style="cursor: pointer;" class="text-decoration-none fs-5 text-secondary dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">EUR</a>


            <ul class="dropdown-menu dropdown-menu-dark " aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item" onclick="ChangeCurrencyAccount('USD')">USD</a></li>
              <li><a class="dropdown-item" onclick="ChangeCurrencyAccount('EUR')">EUR</a></li>
              <li><a class="dropdown-item" onclick="ChangeCurrencyAccount('RON')">RON</a></li>
            </ul>
          </div>
